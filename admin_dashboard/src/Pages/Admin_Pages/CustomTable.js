                                    ...
                                    <div className='row px-md-5 '>
                                        <div className="row ">
                                            <div className="mb-1 col">
                                                ...
                                                <input type="text" className="form-control" id="ProductName" name="OuterwearName" onChange={AddProduct} value={product.name} placeholder=''></input>
                                            </div>
                                            <div className='mb-1 col'>
                                                <div className="row mt-1">
                                                    <div className="col">
                                                        ...
                                                        <div className="input-group">
                                                            <input type="text" className="form-control" name="OuterwearPrice" onChange={AddProduct} value={product.price} placeholder="50"
                                                                id="ProductPrice"
                                                    ...
                                                    <div className="dropdown col d-flex flex-column ">
                                                        ...
                                                        <select className="form-select" aria-label="Default select example" id="ProductGender" value={product.gender} onChange={AddProduct} >
